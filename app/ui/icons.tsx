...
export const Menu = ({ strokeWidth = 1.5, ...props }: IconProps) => (
  <IconWrapper {...props}>
    <svg
...
export const ChevronLeft = ({ strokeWidth = 2, ...props }: IconProps) => (
  <IconWrapper {...props} size={12}>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
...
export const JS = ({ strokeWidth, ...props }: IconProps) => (
  <IconWrapper {...props}>
...
const IconWrapper = ({
  ...
  className = "",
  ...props
}: PropsWithChildren<Omit<IconProps, "strokeWidth">>) => (
  <div className={clsx(`w-${size / 4} h-${size / 4}`, className)} {...props}>
    {children}
  </div>
);
